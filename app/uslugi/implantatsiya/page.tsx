...
export const metadata: Metadata = {
  title: 'Имплантация зубов | Стоматология АПЕКС в Южном Бутово',
  description:
    'Имплантация зубов под ключ в АПЕКС Дентал, Южное Бутово. Nobel Biocare, Straumann, Dentium, Alfa Bio, Ot Medical. All-on-4/All-on-6. Запись: +7 (495) 711-01-00.',
};
...
const implantDoctorIds = ['andreychuk', 'vafaev', 'darsigov'];
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 text-text-muted leading-relaxed">
          <p>
            ...
            зуба: нагрузка передаётся на кость, предотвращая её убыль. Мы работаем с пятью проверенными
            системами: <strong className="text-primary">Nobel Biocare</strong> и <strong className="text-primary">Straumann</strong> — для
            пациентов, которым важны самые высокие стандарты биосовместимости и долговечности;{' '}
            <strong className="text-primary">Dentium</strong>, <strong className="text-primary">Alfa Bio</strong> и{' '}
            <strong className="text-primary">Ot Medical</strong> — надёжные решения среднего ценового сегмента
            с отличными клиническими показателями.
          </p>
          <p>
