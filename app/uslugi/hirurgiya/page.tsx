...
export const metadata: Metadata = {
  title: 'Хирургия | Стоматология АПЕКС в Южном Бутово',
  description:
    'Удаление зубов любой сложности, костная пластика, цистэктомия, ЧЛХ в АПЕКС Дентал, Южное Бутово. Хирурги-имплантологи. Запись: +7 (495) 711-01-00.',
};
...
const hirurgiyaDoctorIds = ['andreychuk', 'darsigov', 'balabanova', 'rylik'];
    ...
    <main id="main-content" className="max-w-5xl mx-auto px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 text-text-muted leading-relaxed">
          <p>
            Хирургическая стоматология в АПЕКС — это плановые и неотложные вмешательства любой
            ...
            наиболее технически сложный вариант.
          </p>
          <p>
            Хирург Андрейчук Сергей Владиславович специализируется на челюстно-лицевой хирургии
            (ЧЛХ): он занимается резекцией верхушек корней с удалением кист, цистэктомией,
          ...
          <p>
            ...
            плановый осмотр через 7–10 дней для снятия швов. При осложнениях (альвеолярный неврит,
            кровотечение) врачи принимают пациента вне очереди.
          </p>
        </div>
      </section>
