...
export const metadata: Metadata = {
  title: 'Детская стоматология | АПЕКС в Южном Бутово',
  description:
    'Заботливый приём детей с 3 лет в АПЕКС Дентал, Южное Бутово. Врачи Рылик А.Ю. и Шитова Т.В., стаж 37 и 20 лет. Лечение в игровой форме. Запись: +7 (495) 711-01-00.',
};
...
const detskayaDoctorIds = ['rylik', 'shitova'];
    ...
    <main id="main-content" className="max-w-5xl mx-auto px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 text-text-muted leading-relaxed">
          <p>
            Детская стоматология в АПЕКС — это специализированный приём от врачей с многолетним
            опытом работы с детьми. Рылик Анжела Юрьевна (37 лет практики) и Шитова Татьяна
            Валерьевна (20 лет практики) умеют найти подход к самым маленьким и тревожным пациентам:
            знакомство с оборудованием, рассказ в игровой форме, мягкие движения — всё это делает
            визит к стоматологу спокойным событием, а не стрессом.
          </p>
          <p>
          ...
          <p>
            ...
            Уже с 6–7 лет наш ортодонт оценивает формирование прикуса и при необходимости
