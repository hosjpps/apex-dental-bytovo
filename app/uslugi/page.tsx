...
export const metadata: Metadata = {
  ...
  description:
    'Актуальный прайс-лист стоматологии АПЕКС в Южном Бутово. 154 услуги: терапия, имплантация, ортодонтия, хирургия, ортопедия.',
};
  ...
  return (
    <main id="main-content" className="max-w-5xl mx-auto px-4 py-12">
      ...
      <p className="text-text-muted mb-8">
        Полный прайс-лист по 5 категориям. Цены действительны на момент публикации.
      </p>
