...
export const metadata: Metadata = {
  title: 'Ортодонтия | Стоматология АПЕКС в Южном Бутово',
  description:
    'Брекеты, элайнеры и пластинки для ровной улыбки в АПЕКС Дентал, Южное Бутово. Взрослые и дети. Металл, керамика, элайнеры 3D Smile, Еврокапы. Запись: +7 (495) 711-01-00.',
};
...
const ORTODONT_PROCEDURES = [
  ...
  'Элайнеры (Еврокапы, 3D Smile)',
  'Пластинки съёмные для детей',
  'Аппарат Марко-Росса / Твин-блок Кларка',
  'Ретейнеры и ретенционные капы после лечения',
];

const ortodontDoctorIds = ['shkabrika'];
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 text-text-muted leading-relaxed">
          ...
          <p>
            ...
            крепятся с внутренней стороны зубного ряда. Элайнеры (прозрачные съёмные капы Еврокапы
            и 3D Smile) подходят для лёгкой и средней степени нарушения прикуса и практически
            незаметны в повседневной жизни. Средний срок активного лечения — от 12 до 24 месяцев в зависимости
            от сложности случая.
          </p>
          <p>
            Для детей от 6 лет применяются съёмные пластинки — они помогают направить рост челюсти
            на этапе смены зубов, когда кость ещё достаточно пластична. При скелетных нарушениях
            прикуса используются аппарат Марко-Росса и Твин-блок Кларка. После завершения активной фазы
