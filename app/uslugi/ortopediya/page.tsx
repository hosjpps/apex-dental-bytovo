...
export const metadata: Metadata = {
  title: 'Ортопедия | Стоматология АПЕКС в Южном Бутово',
  description:
    'Коронки, виниры, протезирование на имплантах в АПЕКС Дентал, Южное Бутово. Циркониевые коронки, виниры E-max, бюгельные и нейлоновые протезы. Запись: +7 (495) 711-01-00.',
};

const ORTOPEDIYA_PROCEDURES = [
  'Коронка металлокерамическая (standart и premium)',
  'Коронка циркониевая безметалловая',
  'Винир керамический лабораторный (E-max)',
  'Винир композитный прямой',
  'Съёмный протез (акриловый, нейлоновый Квадротти)',
  'Бюгельный протез',
  'All-on-4 / All-on-6 — несъёмный протез на имплантах',
  'Wax-Up / Mock-Up — моделирование и примерка результата',
];

const ortopediyaDoctorIds = ['vafaev'];
    ...
    <main id="main-content" className="max-w-5xl mx-auto px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 text-text-muted leading-relaxed">
          ...
          <p>
            Для одиночной коронки мы предлагаем три материала. <strong className="text-primary">Металлокерамика</strong> —
            ...
            <strong className="text-primary">E-max</strong> — прессованная керамика для фронтальных зубов
            и виниров: идеальная имитация натуральной эмали. Для лабораторных виниров E-max врач
            предварительно выполняет Wax-Up (восковое моделирование) и Mock-Up (временный прототип),
            чтобы пациент мог оценить результат ещё до начала препарирования.
          </p>
          <p>
            Съёмное протезирование — для пациентов при полном или частичном отсутствии зубов.
            Нейлоновый протез (Квадротти) отличается мягкостью, отсутствием металлических кламмеров
            и отличной эстетикой; бюгельный — самая надёжная съёмная конструкция с металлическим
            каркасом. При наличии имплантатов мы изготавливаем балочные и условно-съёмные протезы
