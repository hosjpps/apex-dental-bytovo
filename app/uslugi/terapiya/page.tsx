...
export const metadata: Metadata = {
  title: 'Терапия | Стоматология АПЕКС в Южном Бутово',
  description:
    'Лечение кариеса, профессиональная чистка и реставрация зубов в АПЕКС Дентал, Южное Бутово. Безболезненно, анестезия Ультракаин, материалы Asteria и Filtek. Запись: +7 (495) 711-01-00.',
};

const TERAPIYA_PROCEDURES = [
  'Консультация и осмотр стоматолога-терапевта',
  'Лечение кариеса (фотополимерная пломба Asteria, Filtek)',
  ...
  'Глубокое фторирование (Bifluorid-12)',
];

const terapiyaDoctorIds = ['balabanova', 'rylik', 'shitova'];
    ...
    <main id="main-content" className="max-w-5xl mx-auto px-4 py-12">
      ...
      <section className="mb-12">
        ...
        <div className="space-y-4 text-text-muted leading-relaxed">
          ...
          <p>
            Болезненность — главное опасение пациентов. Мы используем современный анестетик{' '}
            <strong className="text-primary">Ультракаин</strong> с предварительной аппликационной
            анестезией: сначала десну обезболивают гелем, а затем делают инъекцию — пациент практически
            не чувствует укол. Для восстановления зубов применяем материалы <strong className="text-primary">Asteria</strong>{' '}
            и <strong className="text-primary">Filtek</strong> — современные светоотверждаемые фотополимеры
            с превосходным цветом и износостойкостью. Художественная реставрация premium позволяет
            восстановить скол или дефект так, что линия реставрации становится невидимой.
          </p>
          <p>
